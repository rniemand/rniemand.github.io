...
- [Rn.NetCore.WebCommon](https://github.com/rniemand/Rn.NetCore.WebCommon) - Common web classes and abstractions ([NuGet](https://www.nuget.org/packages/Rn.NetCore.WebCommon/))
...
- [Rn.NetCore.TestingCore](https://github.com/rniemand/Rn.NetCore.TestingCore) - Common classes for testing code ([NuGet](https://www.nuget.org/packages/Rn.NetCore.TestingCore/))
...
## Web Apps \ APIs
- [document-sink](https://github.com/rniemand/document-sink) - ElasticSearch document ingestion API
- [time-tracker](https://github.com/rniemand/time-tracker) - Time tracking application ([Docker](https://hub.docker.com/repository/docker/niemandr/timetracker))
- [simple-dash](https://github.com/rniemand/simple-dash) - `WIP`: Home dashboard for your common URLs ([Docker](https://hub.docker.com/repository/docker/niemandr/simple-dash))
...
- [NasFileIndexer](https://github.com/rniemand/NasFileIndexer) - Indexes and reports on my NAS files ([Docker](https://hub.docker.com/repository/docker/niemandr/nas-file-indexer))
- [mqtt-document-sink](https://github.com/rniemand/mqtt-document-sink) - Dumps MQTT events into document-sink ([Docker](https://hub.docker.com/repository/docker/niemandr/mqtt-document-sink))
