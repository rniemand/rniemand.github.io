...
export default function (eleventyConfig) {
	...
	eleventyConfig.addFilter("readableDate2", (dateObj, format, zone) => {
		// Formatting tokens for Luxon: https://moment.github.io/luxon/#/formatting?id=table-of-tokens
		return DateTime.fromJSDate(dateObj, {zone: zone || "utc"}).toFormat(format || "dd MMM yyyy");
	});
	...
	eleventyConfig.addFilter("dumpKeys", (data) => {
